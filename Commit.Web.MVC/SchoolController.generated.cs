...
namespace Commit.Web.Razor.Controllers.Web
{
    public partial class SchoolController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Info = "~/Views/School/Info.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SchoolController : Commit.Web.Razor.Controllers.Web.SchoolController
    {
        public T4MVC_SchoolController() : base(Dummy.Instance) { }

        [NonAction]
        partial void InfoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string name);

        [NonAction]
        public override System.Web.Mvc.ActionResult Info(string name)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Info);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "name", name);
            InfoOverride(callInfo, name);
            return callInfo;
        }
